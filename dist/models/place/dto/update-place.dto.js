...
let UpdatePlaceDto = class UpdatePlaceDto {
    constructor(args) {
        this.name = args.name;
        this.city = args.city;
...
__decorate([
    (0, nestjs_joi_1.JoiSchema)(Joi.string()),
...
__decorate([
    (0, nestjs_joi_1.JoiSchema)(Joi.string()),
    __metadata("design:type", String)
], UpdatePlaceDto.prototype, "state", void 0);
exports.UpdatePlaceDto = UpdatePlaceDto = __decorate([
